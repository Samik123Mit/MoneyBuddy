...
from moneybuddy.api.analytics_helpers import (
...
from moneybuddy.core import calculator
from moneybuddy.core.time_filter import TimeRange
from moneybuddy.db.models import TransactionType, User, UserPreferences
...
def get_generated_insights(
    ...
    """Get generated insights from transaction data.
    ...
    """
    from moneybuddy.core.insights import InsightEngine
