"""FastAPI application for moneybuddy web interface."""
...
from moneybuddy.api.account_classifications import (
    router as account_classifications_router,
)
from moneybuddy.api.analytics import router as analytics_router
from moneybuddy.api.analytics_v2 import router as analytics_v2_router
from moneybuddy.api.auth import router as auth_router
from moneybuddy.api.calculations import router as calculations_router
from moneybuddy.api.categorization_rules import router as categorization_rules_router
from moneybuddy.api.exchange_rates import router as exchange_rates_router
from moneybuddy.api.meta import router as meta_router
from moneybuddy.api.oauth import router as oauth_router
from moneybuddy.api.preferences import router as preferences_router
from moneybuddy.api.rate_limit import limiter
from moneybuddy.api.rates import router as rates_router
from moneybuddy.api.reports import router as reports_router
from moneybuddy.api.saved_views import router as saved_views_router
from moneybuddy.api.stock_price import router as stock_price_router
from moneybuddy.api.transactions import router as transactions_router
from moneybuddy.api.upload import router as upload_router
from moneybuddy.config.settings import settings
from moneybuddy.db.session import get_engine, init_db
from moneybuddy.schemas.transactions import HealthResponse
from moneybuddy.utils.logging import logger, setup_logging

_MiddlewareCallNext = Callable[[Request], Awaitable[Response]]

APP_VERSION = "2.24.0"

# Initialize logging at the configured level (MONEYBUDDY_LOG_LEVEL, default INFO)
...
app = FastAPI(
    ...
    description="API for transaction ingestion, reconciliation, and financial analytics.",
    version=APP_VERSION,
    lifespan=lifespan,
)
