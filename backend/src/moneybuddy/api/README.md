# MoneyBuddy API Package

FastAPI routers for MoneyBuddy. The generated OpenAPI document is the schema source of truth; [docs/API.md](../../../../docs/API.md) provides the maintained human-readable inventory.
