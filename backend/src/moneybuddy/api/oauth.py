...
from moneybuddy.api.deps import DatabaseSession, HttpClient
from moneybuddy.api.rate_limit import limiter
from moneybuddy.config.settings import settings
from moneybuddy.schemas.auth import OAuthCallbackRequest, OAuthProviderConfig, Token
from moneybuddy.services.auth_service import AuthService

logger = logging.getLogger("moneybuddy.oauth")
