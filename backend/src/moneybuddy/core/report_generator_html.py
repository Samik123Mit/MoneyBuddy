...
if TYPE_CHECKING:
    from moneybuddy.core.report_generator import MonthlyReportData
...
<body>
    ...
    <p class="subtitle">Generated from MoneyBuddy</p>
    ...
    <div class="footer">
        MoneyBuddy &middot; Monthly Financial Report &middot; {data.month_name} {data.year}
    </div>
</body>
</html>"""
