...
from moneybuddy.core.insight_rules import DEFAULT_CURRENCY_SYMBOL
from moneybuddy.core.ledger_clock import ledger_today
from moneybuddy.db.models import TransactionType

if TYPE_CHECKING:
    from datetime import date

    from moneybuddy.db.models import Transaction
