"""Logging configuration for moneybuddy.
...
def setup_logging(log_level: str | None = None) -> logging.Logger:
    ...
    # Main app logger
    main_logger = logging.getLogger("moneybuddy")
    ...
    try:
        ...
        analytics_logger = logging.getLogger("moneybuddy.analytics")
        ...
        # Don't propagate to the parent moneybuddy logger -- analytics has
        # its own dedicated file handler and we don't want each line to
        # also land in moneybuddy.log via the parent's file_handler.
...
def get_analytics_logger() -> logging.Logger:
    ...
    return logging.getLogger("moneybuddy.analytics")
